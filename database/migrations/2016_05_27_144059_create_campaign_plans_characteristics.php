...
class CreateCampaignPlansCharacteristics extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('campaign_plans_characteristics', function (Blueprint $table) {
            $table->increments('id');
            $table->string('title');
            $table->decimal('price');
    ...
    {
        Schema::drop('campaign_plans_characteristics');
    }
}
